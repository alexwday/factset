...
Usage: python transcript_compare_v2.py <pdf/txt file> <html file> [output.html]
"""
...
def main():
    """Main entry point."""
    if len(sys.argv) < 3:
        print("Usage: python transcript_compare_v2.py <pdf/txt file> <html file> [output.html]")
    ...
    # Run comparison
    print(f"Comparing transcripts (v2 - enhanced normalization)...")
